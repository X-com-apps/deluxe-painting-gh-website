...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="animate-fade-in-up inline-block mb-6">
            <span className="px-4 py-2 bg-gold/20 border border-gold/40 rounded-full text-gold text-sm font-medium tracking-wider">
          ...
          <p className="animate-fade-in-delay-2 text-lg md:text-xl text-cream/70 mb-10 max-w-2xl mx-auto leading-relaxed">
            We are a premier painting company dedicated to delivering exceptional
            painting experiences for residential, commercial, and industrial
          ...
          <div className="mt-16 grid grid-cols-3 gap-8 max-w-xl mx-auto animate-fade-in-delay-3">
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-display font-bold text-gold mb-1">3+</div>
              <div className="text-cream/60 text-sm">Years Warranty</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-display font-bold text-gold mb-1">500+</div>
              <div className="text-cream/60 text-sm">Projects Done</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-display font-bold text-gold mb-1">100%</div>
      ...
      <button
        onClick={scrollToAbout}
        className="absolute bottom-8 left-1/2 -translate-x-1/2 text-gold animate-bounce cursor-pointer"
      >
