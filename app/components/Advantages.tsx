...
const Advantages = () => {
  ...
  return (
    <section id="advantages" className="py-20 lg:py-32 bg-secondary relative overflow-hidden">
      {/* Decorative Elements */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="text-cream/70 text-lg">
            We&apos;re committed to delivering excellence at every step of your
            painting project.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6">
          {advantages.map((advantage, index) => {
            ...
            return (
              <div
                key={advantage.title}
                className="group bg-charcoal hover:bg-charcoal-light rounded-2xl p-6 text-center transition-all duration-300 hover:-translate-y-1 hover:shadow-lg"
                style={{ animationDelay: `${index * 50}ms` }}
              >
                <div className="w-14 h-14 mx-auto rounded-xl bg-gold/10 flex items-center justify-center mb-4 transition-colors group-hover:bg-gold/20">
        ...
        {/* Promise Section */}
        <div className="mt-20 bg-linear-to-r from-gold/10 via-gold/5 to-gold/10 rounded-3xl p-8 md:p-12 text-center">
